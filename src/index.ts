  ...
  try {
    ...
    if (equipmentType === "chwPump") {
      ...
      const response = Array.from({ length: 70 }, (_, i) => {
        ...
        return {
          chwPump_1_actual_eff: (Math.random() * (0.60 - 0.40) + 0.40).toFixed(2),
          chwPump_2_actual_eff: (Math.random() * (0.61 - 0.41) + 0.41).toFixed(2),
          chwPump_3_actual_eff: (Math.random() * (0.63 - 0.43) + 0.43).toFixed(2),
          date: formattedDate, // Use the custom formatted date
          chwPump_1_target_eff: (Math.random() * (0.62 - 0.42) + 0.42).toFixed(2),
          chwPump_2_target_eff: (Math.random() * (0.63 - 0.43) + 0.43).toFixed(2),
          chwPump_3_target_eff: (Math.random() * (0.64 - 0.44) + 0.44).toFixed(2),
        };
      });
